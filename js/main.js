...
if (talkModal) {
  ...
  const openTalk1 = document.getElementById("openTalk1");
  ...
  if (openTalk1) openTalk1.addEventListener("click", openTalkModal);
...
const impactSlides = document.querySelectorAll(".impact-slide");
...
function nextImpactSlide() {
  ...
  if (impactIndex >= impactSlides.length) {
    impactIndex = 0;
  }
